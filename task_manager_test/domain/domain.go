...
type PasswordService interface {
	IsPasswordCorrect(password string, hashedPassword string) error
	HashPassword(password string) ([]byte, error)
}

// JWTService provides functions to generate and validate JWT tokens.
type JWTService interface {
	GenerateToken(id string, username string, role Role) (string, error)
